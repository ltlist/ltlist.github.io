...
const msg = document.getElementById("kotakPesan");
...
async function loadData(){
    try{
        if(msg) msg.innerText = "Loading data...";
        ...
        if(!Array.isArray(json)){
            throw new Error("Format API bukan array JSON");
        }

        data = json;

        if(msg) msg.innerText = `✔ ${data.length} faucets loaded`;
